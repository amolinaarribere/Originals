...
contract("Testing Manager",function(accounts){
    ...
    const PropositionValues = [zeroBytes, zeroBytes, address_1, address_2, address_3, address_4, address_5, address_6, address_7,
        emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes];
    ...
    async function checkProxyAddresses( _ma, _ppa, _ta, _oa, _ps, _apb){
    ...
    async function checkImplAddresses( _ma, _ppa, _ta, _oa, _ps, _apb, _nft){
    ...
    it("Retrieve Configuration",async function(){
        // assert
        await checkProxyAddresses(managerProxy._address, publicPoolProxy._address, treasuryProxy._address, originalsTokenProxy._address, propositionSettingsProxy._address, adminPiggyBankProxy._address);
        await checkImplAddresses(manager, publicPool, treasury, originalsToken, propositionSettings, adminPiggyBank, marketNFT);
    });
    ...
    it("Vote/Propose/Cancel Contracts Configuration CORRECT Empty",async function(){
        ...
        var PropositionValues_2 = [zeroBytes, zeroBytes, address0, address0, address0, address0, address0, address0, address0,
            emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes, emptyBytes];
