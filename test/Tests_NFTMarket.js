...
contract("Testing NFT Markets",function(accounts){
    ...
    it("Change Configuration CORRECT",async function(){
     ...
     it("Minting WRONG",async function(){
        await GenerateMarkets(false);
        try{
            await Market_1.methods.mintToken(0, user_1, [10], false, 0).send({from: user_1, gas: Gas}, function(error, result){});
            expect.fail();
        }
        // assert
        catch(error){
        ...
        try{
            await Market_1.methods.mintToken(0, user_1, [10], true, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
            expect.fail();
        }
        // assert
        catch(error){
        ...
        try{
            ...
            await Market_1.methods.mintToken(0, user_1, [10], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
            expect.fail();
        }
        // assert
        catch(error){
    ...
    it("Minting CORRECT",async function(){
        ...
        await publicpoolProxy.methods.sendCredit(issuer_1, mintingFee, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
        await Market_1.methods.mintToken(tokenId, user_1, [tokenPrice], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
        let token_1_1 = await Market_1.methods.retrieveToken(tokenId).call();
        await Market_1.methods.mintToken(tokenId + 1, user_1, [tokenPrice], true, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
        let token_1_2 = await Market_1.methods.retrieveToken(tokenId).call();
        await Market_2.methods.mintToken(tokenId, user_1, [tokenPrice], false, 0).send({from: issuer_2, gas: Gas}, function(error, result){});
    ...
    it("Set Token Price CORRECT",async function(){
        ...
        expect(token[0]._prices[0]).to.equal((2 * tokenPrice).toString());
    });
    ...
    it("Submit Offer WRONG",async function(){
        ...
        await Market_1.methods.mintToken(tokenId, user_1, [tokenPrice], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
        try{
            await Market_1.methods.submitOffer(tokenId, user_2, tokenPrice - 1, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
            expect.fail();
        }
        // assert
        catch(error){
        ...
        try{
            await mockdai.methods.approve(paymentsProxyAddress, tokenPrice - 1).send({from: user_2, gas: Gas}, function(error, result){});
            await Market_1.methods.submitOffer(tokenId, user_2, tokenPrice, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
            expect.fail();
        }
        // assert
        catch(error){
        ...
        try{
            await Market_1.methods.submitOffer(tokenId, user_2, tokenPrice, true, 0).send({from: user_2, gas: Gas}, function(error, result){});
            expect.fail();
        }
        // assert
        catch(error){
        ...
        try{
            ...
            await Market_1.methods.submitOffer(tokenId, user_2, tokenPrice, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
            await Market_1.methods.submitOffer(tokenId, user_1, tokenPrice, false, 0).send({from: user_1, gas: Gas}, function(error, result){});
            expect.fail();
        }
        // assert
        catch(error){
    ...
    it("Submit Offer CORRECT",async function(){
        ...
        await mockdai.methods.approve(paymentsProxyAddress, mintingFee.multipliedBy(2)).send({from: issuer_1, gas: Gas}, function(error, result){});
        await Market_1.methods.mintToken(tokenId, user_1, [tokenPrice], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
        await Market_1.methods.mintToken(tokenId + 1, user_1, [tokenPrice], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});

        await mockdai.methods.approve(paymentsProxyAddress, 2 * tokenPrice).send({from: user_2, gas: Gas}, function(error, result){});
        await publicpoolProxy.methods.sendCredit(user_2, tokenPrice, 0).send({from: user_2, gas: Gas}, function(error, result){});
        await Market_1.methods.submitOffer(tokenId, user_2, tokenPrice, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
        await Market_1.methods.submitOffer(tokenId + 1, user_3, tokenPrice, true, 0).send({from: user_2, gas: Gas}, function(error, result){});
    ...
    it("Withdraw Offer WRONG",async function(){
        ...
        try{
            await mockdai.methods.approve(paymentsProxyAddress, mintingFee).send({from: issuer_1, gas: Gas}, function(error, result){});
            await Market_1.methods.mintToken(tokenId_1, user_1, [tokenPrice], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
            await mockdai.methods.approve(paymentsProxyAddress, 2 * tokenPrice).send({from: user_2, gas: Gas}, function(error, result){});
            await Market_1.methods.submitOffer(tokenId_1, user_2, tokenPrice, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
        ...
        try{
            ...
            await Market_1.methods.changeOffersLifeTime(newLifeTime).send({from: issuer_1, gas: Gas}, function(error, result){});
            await mockdai.methods.approve(paymentsProxyAddress, mintingFee).send({from: issuer_1, gas: Gas}, function(error, result){});
            await Market_1.methods.mintToken(tokenId_2, user_1, [tokenPrice], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
            await mockdai.methods.approve(paymentsProxyAddress, 2 * tokenPrice).send({from: user_2, gas: Gas}, function(error, result){});
            await Market_1.methods.submitOffer(tokenId_2, user_2, tokenPrice, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
    ...
    it("Reply Offer WRONG",async function(){
        ...
        try{
            ...
            await mockdai.methods.approve(paymentsProxyAddress, tokenPrice).send({from: user_2, gas: Gas}, function(error, result){});
            await Market_2.methods.submitOffer(tokenId, user_2, tokenPrice, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
    ...
    it("Reply Offer CORRECT",async function(){
        ...
        await mockdai.methods.approve(paymentsProxyAddress, mintingFee.multipliedBy(2)).send({from: issuer_1, gas: Gas}, function(error, result){});
        await Market_1.methods.mintToken(tokenId, user_1, [tokenPrice], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
        await Market_1.methods.mintToken(tokenId_2, user_1, [tokenPrice_2], false, 0).send({from: issuer_1, gas: Gas}, function(error, result){});
        ...
        await Market_1.methods.submitOffer(tokenId, user_2, tokenPrice, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
        await Market_1.methods.submitOffer(tokenId_2, user_2, tokenPrice_2, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
        ...
        await Market_2.methods.mintToken(tokenId, user_1, [tokenPrice], false, 0).send({from: issuer_2, gas: Gas}, function(error, result){});
        await Market_2.methods.mintToken(tokenId_2, user_1, [tokenPrice_2], false, 0).send({from: issuer_2, gas: Gas}, function(error, result){});

        await mockdai.methods.approve(paymentsProxyAddress, 2 * tokenPrice + tokenPrice_2).send({from: user_2, gas: Gas}, function(error, result){});
        await Market_2.methods.submitOffer(tokenId, user_2, tokenPrice, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
        await Market_2.methods.submitOffer(tokenId_2, user_2, tokenPrice_2, false, 0).send({from: user_2, gas: Gas}, function(error, result){});
        ...
        expect(ownertoken_2).to.equal(user_2);
        await publicpoolProxy.methods.sendCredit(user_2, tokenPrice, 0).send({from: user_2, gas: Gas}, function(error, result){});
        await Market_2.methods.submitOffer(tokenId, user_2, tokenPrice, true, 0).send({from: user_2, gas: Gas}, function(error, result){});
        await Market_2.methods.acceptOffer(tokenId).send({from: user_1, gas: Gas}, function(error, result){});
        ownertoken = await Market_2.methods.ownerOf(tokenId).call();
        expect(ownertoken).to.equal(user_2);
