...
contract Treasury is ITreasury, StdPropositionBaseContract, CreditorBaseContract{
    ...
    function InternalWithdraw(uint amount) internal 
    {
        ...
        ItemsLibrary.InternalWithdraw(_balances[msg.sender], amount, msg.sender, true, _managerContract.retrieveTransparentProxies()[uint256(Library.TransparentProxies.Payments)]);
